            ...
            <div className="hero-style1">
              ...
              <p className="hero-text">
                {page === "web" && (
                  <>
                    <h6>
                      Our web app development services are customized to tackle
                      the unique challenges of your business.
                    </h6>
                    <p>
                      At Visionary AI Technologies, we take pride in offering a
                      wide range of advanced technologies to deliver dependable
                      web application development solutions to clients globally.
                ...
                {page === "app" && (
                  <>
                    ...
                    <p>
                      ...
                      consistently enhancing our services to meet your evolving
                      needs.
                    </p>
                  </>
                )}
